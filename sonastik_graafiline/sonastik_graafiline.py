...
btn2=Button(text="lisa vene sõna",font="Arial 24",relief=GROOVE)
btn3=Button(text="lisa eesti sõna",font="Arial 24",relief=GROOVE)
btn4=Button(text="paranda vigu vene",font="Arial 24",relief=GROOVE)
btn5=Button(text="paranda vigu eesti",font="Arial 24",relief=GROOVE)
